...
<title>부끄북스</title>
    ...
    <script type="text/javascript" src="https://contents.kyobobook.co.kr/resources/fo/js/common-vars.js?t=2472914488"></script>
    	...
    	function login() {
   		 ...
   		 f.action = "<%=cp%>/bkJoin/login_ok.do";
   		 f.submit();
           ...
           <form action="" method="post" name="myForm" >
            ...
            <div class="save_id_box">
                ...
                <div class="right_area">
                    <a href="http://192.168.16.5:8080/books/bkJoin/Id.do">
                        <span class="text btn_text_id_link">아이디 찾기</span>
                    </a>
                    <span class="gap">|</span>
                    <a href="http://192.168.16.5:8080/books/bkJoin/pwd.do">
		...
		<font color="red"><b>${Message }</b></font>
          	...
          	<div>
                ...
                <!-- 회원가입 -->
 					  ...
 					  <div class="btn_wrap justify">
                        <a href="http://192.168.16.5:8080/books/create/create.jsp" class="btn_lg btn_line_primary" id="join"><span class="text">회원가입</span></a>
                    </div>
