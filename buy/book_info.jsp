...
<div class="prod_purchase_info_wrap">
    ...
    <div class="footer_contents_inner">
        ...
        <div class="right_area">
            <div id="count" class="form_spinner_box">
            	<form id="countForm" action="KrbookServlet" method="post">
            <label for="count">수량:</label>
            <input type="number" id="countInput" name="count" required><br><br>
            <!-- 추가 버튼은 더 이상 필요하지 않을 수 있음 -->
        </form>
            </div>
            ...
            <div id="prodBtnWrap" class="btn_wrap multi">
                ...
                <button id="basket" type="button" class="btn_lg btn_line_primary" 
                onclick="location.href='<%=cp%>/bkInfo/cart.com?ISBN=${ISBN }'"><span class="text" 
                		onclick="javascript:location.href='<%=cp%>/bkInfo/cart.com';">
                		장바구니</span></button>
  ...
  <script>
    function submitForm() {
        // 수량이 입력되지 않은 경우에 대한 기본값 설정 가능
        var countInput = document.getElementById("countInput");
        if (!countInput.value) {
            countInput.value = 1; // 기본값 설정
        }
