                    ...
                    <div class="prod_area horizontal">
                        ...
                        <div class="prod_thumb_box  size_sm">
                            <!--DESC:링크일경우 aTag 추가, 아닐경우 a태그 삭제 -->
                                ...
                                <span class="img_box">
                                    <img src="https://contents.kyobobook.co.kr/sih/fit-in/200x0/pdt/9791170611561.jpg" alt="[국내도서]당신이 누군가를 죽였다">
                                </span>
                            </a>
        ...
        <div class="payments_info_box">
            ...
            <ul class="payments_info_list">
                <li class="payments_info_item">
                    ...
                    <div class="right_box">
                        <span class="price">
                            <span class="val spot" data-amount="commodity">39,600</span>
                            <span class="unit">원</span>
                        </span>
                    </div>
                </li>
