...
/*
    ...
    const mmbrNum = "62242894934" !== null ? "62242894934" : '';
                ...
                <li class="prod_thumb_item swiper-slide">
                    <div class="blur_img_wrap">
                        ...
                        <div class="portrait_img_box">
                            ...
                            <img src="${bookpath }/${filedto.cover}"
...
<div class="product_detail_area detail_img">
    <div class="inner">
       ...
       <c:choose>
        ...
        <c:otherwise>
            <!-- filedto.image가 비어 있지 않을 때 표시할 내용 -->
            <img src="${filedto.image}" alt="상세 이미지">
        </c:otherwise>
    	</c:choose>
                    	...
                    	<li class="prod_item swiper-slide">
                        	<div class="prod_area">
                            	<div class="prod_thumb_box author_book_item"
                                 	...
                                 	data-index="1">
                                	<a href="${bookpath }/${filedto.cover }" class="prod_link">
                                    	<span class="img_box">
                                        	<img
                                        		src="${bookpath }/${filedto.cover }"
                                            	data-kbbfn="s3-image"
...
<!-- 클로버 리뷰 작성하기 6700~6813 -->
			...
			<div class="product_detail_area basic_info">
    			<div class="title_wrap title_size_md has_btn">
        			<h2 class="title_heading">리뷰</h2>
    			
    				<div class="right_area">
    					<button type="button" data-kbbfn-type="002" data-kbbfn-role="post" data-kbbfn-title="리뷰 작성" data-kbbfn-list-for="ReviewList1" class="btn_sm btn_primary" data-role="btn-dialog" data-target="#ReviewList1_934db48c-6ec8-48b9-a10d-cbe2fed613b4_post" data-kbbfn="ui-review-form" data-kbbfn-prod-age="0" data-kbbfn-prod-code="KOR" data-kbbfn-prod-title="당신이 누군가를 죽였다" data-kbbfn-prod-bid="9791170611561" data-kbbfn-prod-pid="S000213800371" id="a03a9532-0950-4e8f-b7f7-95d36599edd2">
