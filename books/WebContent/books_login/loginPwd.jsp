...
<title>부끄북스</title>
    ...
    <script type="text/javascript"> //아이디로 비밀번호 찾기 스크립트
    ...
    function pwd() {
	 ...
	 if(!f.userTel.value){
		 ...
		 f.action = "<%=cp%>/bukkeubooks/pwd_ok.com";
		 f.submit();
    ...
    function Email() {
	 ...
	 f.action = "<%=cp%>/bukkeubooks/Email_pwd.com";
	 f.submit();
...
>
    ...
    <div class="loading_dimmed"></div>
            ...
            <div class="skip_nav_wrap">
                <a href="<%=cp%>/bukkeubooks/bukkeubooks.com">본문 바로가기</a>
            </div>
    ...
    <div class="header_inner">
        ...
        <div class="tab_wrap type_line_primary justify">
            ...
            <div class="tab_list_wrap">
                <ul class="tabs">
                    <li class="tab_item"><a href="#tabContentFindId" class="tab_link"><span class="tab_text">비밀번호 찾기</span></a></li>
...
<div class="form_box">
    ...
    <div class="form_cont">
        <div class="valid_check">
            <input type="text"  name="userId"  class="form_ip" placeholder="아이디를 입력해 주세요." maxlength="50"  />
        </div>
    </div>
</div>
    ...
    <div class="form_cont">
        <div class="form_col_group">
          ...
          <div class="btn_wrap justify">
            <button class="btn_lg btn_light_gray"  onclick="pwd();">확인하기</button>	
         </div>
  	  </div>
	</div>
