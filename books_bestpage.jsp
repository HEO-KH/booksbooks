...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <meta name="description" content="교보문고 온라인 베스트셀러 페이지에서는 온라인에서 주문된 도서, 전자책, 대여상품, 기프트, 교보only상품의 일간 판매량을 집계하여 소개합니다.">
        <meta property="og:description" content="교보문고 온라인 베스트셀러 페이지에서는 온라인에서 주문된 도서, 전자책, 대여상품, 기프트, 교보only상품의 일간 판매량을 집계하여 소개합니다.">
    ...
    <meta property="og:url" content="https://product.kyobobook.co.kr/bestseller/online?period=001">
    
    
        <meta name='twitter:title' content="일간 온라인 베스트셀러 | 국내도서 - 교보문고">
        <meta name='twitter:description' content="교보문고 온라인 베스트셀러 페이지에서는 온라인에서 주문된 도서, 전자책, 대여상품, 기프트, 교보only상품의 일간 판매량을 집계하여 소개합니다.">
        <meta name='twitter:card' content="summary">
        <meta name='twitter:url' content="https://product.kyobobook.co.kr/bestseller/online?period=001">
...
<meta name="format-detection" content="date=no">
    ...
    <link rel="canonical" href="https://product.kyobobook.co.kr/bestseller/online" />
    ...
    <div class="breadcrumb_inner">
        <ol class="breadcrumb_list">
            ...
            <li class="breadcrumb_item no_sub">
                <a href="https://product.kyobobook.co.kr/bestseller/total" class="btn_sub_depth">베스트셀러</a>
            </li>
            <!-- 1 depth lnb -->
            <li class="breadcrumb_item">
                <a href="https://product.kyobobook.co.kr/bestseller/online" class="btn_sub_depth">
                    <span id="depthTitle"></span>
                </a>
                <div class="sub_depth_grid">
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="/bestseller/total?period=002" class="depth_link">종합 베스트</a>
                            </li>
                            <li class="depth_item">
                                <a href="/bestseller/online?period=001" class="depth_link">온라인 베스트</a>
                            </li>
                            <li class="depth_item">
                                <a href="/bestseller/realtime" class="depth_link">실시간 베스트</a>
                            </li>
                            <li class="depth_item">
                                <a href="/bestseller/store?period=002" class="depth_link">매장별 베스트</a>
                            </li>
                            <li class="depth_item">
                                <a href="/bestseller/person?period=001" class="depth_link">인물 베스트</a>
                            </li>
                            <li class="depth_item">
                                <a href="/bestseller/steady" class="depth_link">스테디셀러</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="sub_depth_grid col1">
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list" id="tabList">
                            ...
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=000"
                                   class="depth_link">전체</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=002&amp;saleCmdtDsplDvsnCode=TOT"
                                   class="depth_link">국내도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=002&amp;period=001&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link">외국도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=006&amp;period=001&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link">교보ONLY</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=003&amp;period=001&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link">eBook</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=004&amp;period=001&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link">sam</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;period=001&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=GFT"
                                   class="depth_link">핫트랙스</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- 3 depth 시작 -->
<li class="breadcrumb_item" style="display: none;" id="domestic_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="domestic_breadcrumb_title"></span>
                </a>
                <div id="domestic_breadcrumb_list" class="sub_depth_grid col3">
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                                ...
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=002&amp;saleCmdtDsplDvsnCode=TOT"
                                       class="depth_link" value="">전체</a>
                                </li>
                                
                            
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=01"
                                       class="depth_link" value="01">소설</a>
                                </li>
                                
                            
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=03"
                                       class="depth_link" value="03">시/에세이</a>
                                </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                                ...
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=17"
                                       class="depth_link" value="17">정치/사회</a>
                                </li>
                                
                            
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=19"
                                       class="depth_link" value="19">역사/문화</a>
                                </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                                ...
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=33"
                                       class="depth_link" value="33">컴퓨터/IT</a>
                                </li>
                                
                            
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=001&amp;period=001&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=35"
                                       class="depth_link" value="35">잡지</a>
                                </li>
...
<!-- //상위 탭이 존재하는 경우 -->
<!-- 외국도서 3 depth -->
            <li class="breadcrumb_item" style="display: none;" id="foreign_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="foreign_breadcrumb_title"></span>
                </a>
                <div class="sub_depth_grid col1">
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=002&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link">외국도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=002&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=ENG"
                                   class="depth_link">서양도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=002&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=JAP"
                                   class="depth_link">일본도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004"
                                   class="depth_link">기타언어권</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- 외국도서 3 depth 끝 -->
 <!-- 외국도서 4 depth -->
            <li class="breadcrumb_item" style="display: none;" id="foreign_sub_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="foreign_sub_breadcrumb_title"></span>
                </a>
                
                    
                    <div id="foreign_sub_breadcrumb_list" class="sub_depth_grid col1 hidden" value="foreignList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=002"
                                       class="depth_link">전체</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div id="western_sub_breadcrumb_list" class="sub_depth_grid hidden col2"
                         value="westernList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=ENG"
                                       class="depth_link" value="">전체</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=01"
                                       class="depth_link" value="01">문학</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=03"
                        ...
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=19"
                                       class="depth_link" value="19">문구/멀티/비도서</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=81"
                                       class="depth_link" value="81">ELT/수험서</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    
                    <div id="jap_sub_breadcrumb_list" class="sub_depth_grid hidden col2"
                         value="japanList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=JAP"
                                       class="depth_link" value="">전체</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=41"
                                       class="depth_link" value="41">잡지</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=43"
                        ...
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=59"
                                       class="depth_link" value="59">인문/사회</a>
                                </li>
                                
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=67"
                                       class="depth_link" value="67">중국도서</a>
                                </li>
                            </ul>
                        </div>
                    </div>
					<div id="etc_sub_breadcrumb_list" class="sub_depth_grid hidden col1"
                         value="etcList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode="
                                       class="depth_link" value="">전체</a>
                                </li>
                                
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=002&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=90"
                                       class="depth_link" value="90">스페인도서</a>
                                </li>
                            </ul>
                        </div>
                    </div>
			 ...
			 <li class="breadcrumb_item" style="display: none;" id="ebook_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="ebook_breadcrumb_title"></span>
                </a>
                <div class="sub_depth_grid col3"
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link" value="">전체</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=001"
                                   class="depth_link" value="001">경제경영</a>
                            </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=019"
                                   class="depth_link" value="019">과학/공학</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=021"
                                   class="depth_link" value="021">IT/프로그래밍</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=023"
                                   class="depth_link" value="023">건강/의학</a>
                            </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=039"
                                   class="depth_link" value="039">외국도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=041"
                                   class="depth_link" value="041">매거진</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=071"
                                   class="depth_link" value="071">로맨스</a>
                            </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=091"
                                   class="depth_link" value="091">단행본만화</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=093"
                                   class="depth_link" value="093">웹툰</a>
                            </li>
                            
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=003&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=920"
                                   class="depth_link" value="920">동영상</a>
                            </li>
                        </ul>
                    </div>
                </div>
	...
	<li class="breadcrumb_item" style="display: none;" id="sam_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="sam_breadcrumb_title"></span>
                </a>
                <div class="sub_depth_grid col3"
                     value="samList">
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=002"
                                   class="depth_link" value="">전체</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=001"
                                   class="depth_link" value="001">경제경영</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=003"
                                   class="depth_link" value="003">자기계발</a>
                            </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=019"
                                   class="depth_link" value="019">과학/공학</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=021"
                                   class="depth_link" value="021">IT/프로그래밍</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=023"
                                   class="depth_link" value="023">건강/의학</a>
                            </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=039"
                                   class="depth_link" value="039">외국도서</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=041"
                                   class="depth_link" value="041">매거진</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=071"
                                   class="depth_link" value="071">로맨스</a>
                            </li>
                    ...
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=087"
                                   class="depth_link" value="087">미스터리</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=089"
                                   class="depth_link" value="089">스릴러</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?period=001&amp;dsplDvsnCode=004&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=090"
                                   class="depth_link" value="090">섹슈얼로맨스</a>
                            </li>
            ...
            <li class="breadcrumb_item" style="display: none;" id="hot_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="hot_breadcrumb_title"></span>
                </a>
                <div class="sub_depth_grid col1">
                    <div class="sub_depth_box">
                        <ul class="sub_depth_list">
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=GFT"
                                   class="depth_link">기프트</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=MUC"
                                   class="depth_link">음반</a>
                            </li>
                            <li class="depth_item">
                                <a href="https://product.kyobobook.co.kr/bestseller/online?saleCmdtClstCode=000400&amp;dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004"
                                   class="depth_link">영상</a>
                            </li>
                        </ul>
                    </div>
                </div>
            </li>
<li class="breadcrumb_item" style="display: none;" id="hot_sub_breadcrumb_wrap">
                <a class="btn_sub_depth">
                    <span id="hot_sub_breadcrumb_title"></span>
                </a>
                
                
                    <div id="hotGift_sub_breadcrumb_list" class="sub_depth_grid hidden col1"
                         value="giftList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=GFT&amp;period=001"
                                       class="depth_link" value="">전체</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000000&amp;period=001"
                                       class="depth_link" value="000000">필기구</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000001&amp;period=001"
                                       class="depth_link" value="000001">디자인문구</a>
                                </li>
                    ...
                    <div id="hotMusic_sub_breadcrumb_list" class="sub_depth_grid hidden col2"
                         value="recordList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=003&amp;saleCmdtDsplDvsnCode=MUC&amp;period=001"
                                       class="depth_link" value="">전체</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000300&amp;period=001"
                                       class="depth_link" value="000300">가요</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000301&amp;period=001"
                                       class="depth_link" value="000301">POP</a>
                                </li>
                        ...
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000309&amp;period=001"
                                       class="depth_link" value="000309">국악</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000310&amp;period=001"
                                       class="depth_link" value="000310">유아/아동</a>
                                </li>
                    ...
                    <div id="hotVideo_sub_breadcrumb_list" class="sub_depth_grid hidden col1"
                         value="videoList">
                        <div class="sub_depth_box">
                            <ul class="sub_depth_list">
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000400&amp;period=001"
                                       class="depth_link" value="000400">Blu-Ray</a>
                                </li>
                                <li class="depth_item">
                                    <a href="https://product.kyobobook.co.kr/bestseller/online?dsplDvsnCode=005&amp;dsplTrgtDvsnCode=004&amp;saleCmdtClstCode=000401&amp;period=001"
                                       class="depth_link" value="000401">DVD</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <ul class="snb_list category">
                <li class="snb_item">
                    <a class="snb_link depth_title"
                       href="/bestseller/total?period=002"
                       category2="종합 베스트"
                       onclick="pushBestsellerLnbDataLayer(this)">종합 베스트</a>

                    <ul class="snb_list">
                        <li class="snb_item">
                            <a href="/bestseller/total?period=002" class="snb_link"
                               category2="종합 베스트"
                               category3="주간"
                               onclick="pushBestsellerLnbDataLayer(this)">주간</a>
                        </li>
                        <li class="snb_item">
                            <a href="/bestseller/total?period=003" class="snb_link"
                               category2="종합 베스트"
                               category3="월간"
                               onclick="pushBestsellerLnbDataLayer(this)">월간</a>
                        </li>
                        <li class="snb_item">
                            <a href="/bestseller/total?period=004" class="snb_link"
                               category2="종합 베스트"
                               category3="연간"
                               onclick="pushBestsellerLnbDataLayer(this)">연간</a>
                        </li>
                    </ul>
                </li>
                <li class="snb_item">
                    <a class="snb_link depth_title"
                       href="/bestseller/online?period=001"
                       category2="온라인 베스트"
                       onclick="pushBestsellerLnbDataLayer(this)">온라인 베스트</a>

                    <ul class="snb_list">
                        <li class="snb_item active">
                            <a href="/bestseller/online?period=001" class="snb_link"
                               category2="온라인 베스트"
                               category3="일간"
                               onclick="pushBestsellerLnbDataLayer(this)">일간</a>
                        </li>
                        <li class="snb_item">
                            <a href="/bestseller/online?period=002" class="snb_link"
                               category2="온라인 베스트"
                               category3="주간"
                               onclick="pushBestsellerLnbDataLayer(this)">주간</a>
                        </li>
                        <li class="snb_item">
                            <a href="/bestseller/online?period=003" class="snb_link"
                               category2="온라인 베스트"
                               category3="월간"
                               onclick="pushBestsellerLnbDataLayer(this)">월간</a>
                        </li>
                ...
                <li class="snb_item">
                    <a class="snb_link depth_title"
                       href="/bestseller/realtime"
                       category2="실시간 베스트"
                       onclick="pushBestsellerLnbDataLayer(this)">실시간 베스트</a>
                ...
                <li class="snb_item">
                    <a class="snb_link depth_title"
                       href="/bestseller/person?period=001"
                       category2="인물 베스트"
                       onclick="pushBestsellerLnbDataLayer(this)">인물 베스트</a>

                    <ul class="snb_list">
                        <li class="snb_item">
                            <a href="/bestseller/person?period=001" class="snb_link"
                               category2="인물 베스트"
                               category3="일간"
                               onclick="pushBestsellerLnbDataLayer(this)">일간</a>
                        </li>
                        <li class="snb_item">
                            <a href="/bestseller/person?period=002" class="snb_link"
                               category2="인물 베스트"
                               category3="주간"
                               onclick="pushBestsellerLnbDataLayer(this)">주간</a>
                        </li>
                        <li class="snb_item">
                            <a href="/bestseller/person?period=003" class="snb_link"
                               category2="인물 베스트"
                               category3="월간"
                               onclick="pushBestsellerLnbDataLayer(this)">월간</a>
                        </li>
                ...
                <li class="snb_item">
                    <a class="snb_link depth_title"
                       href="/bestseller/steady"
                       category2="스테디셀러"
                       onclick="pushBestsellerLnbDataLayer(this)">스테디셀러</a>
        ...
        <li class="tab_item ui-state-active">
            <a class="tab_link"
               ...
               onclick="pushBestsellerTabDataLayer(this)">
                <span class="tab_text" value="000">전체</span>
            </a>
        </li>
...
<div class="list_result_wrap">
    ...
    <div class="item_group">
        <span class="form_chk">
            ...
            <button data-kbbfn-cartList="#tabRoot .prod_list"
                    id="btnAllInBasket"
                    type="button" class="btn_sm btn_line_gray"
    ...
    <div class="item_group">
        <button type="button" class="btn_sm btn_line_gray" id="excel_btn" onclick="pushDataLayerForDownExcel()">
            <span class="ico_excel"></span>
            <span class="text">Excel다운로드</span>
        </button>
        <!-- 온라인 베스트 -->
        
            <button type="button" class="btn_filter selected" id="samFilterBtn" style="display: none;">
            ...
            <div id="samFilterWrap" class="list_filter_wrap">
                <div class="list_filter_option">
                    <div class="list_filter_option_bunddle">
                        <span class="form_rdo">
                            <input id="samFilter-1" name="samFilter" type="radio" value="004" checked="true">
                            <label for="samFilter-1">sam 프리미엄</label>
                        </span>
                        <span class="form_rdo">
                            <input id="samFilter-2" name="samFilter" type="radio" value="009">
                            <label for="samFilter-2">sam 무제한</label>
                        </span>
                    </div>
                </div>
                <div class="util_filter">
                    <button type="button" class="btn_xs btn_light_gray" id="applyBtn"><span class="text">적용</span>
                    </button>
                </div>
